 ...
 * @return string
 */
if (!function_exists('tpl_form_field_tags_input')) {
...
// 获取昵称
if (!function_exists('tpl_form_field_nickname')) {
...
// 富文本编辑器
if (!function_exists('tpl_tinymce')) {
 ...
 * @return string
 */
if (!function_exists('tpl_form_field_icon')) {
 ...
 * @return string
 */
if (!function_exists('tpl_form_field_emoji')) {
...
if (!function_exists('tpl_form_field_location_category')) {
 ...
 * @return string
 */
if (!function_exists('tpl_form_field_district')) {
 ...
 * @return string
 */
if (!function_exists('tpl_form_field_clock')) {
...
// 日历选择
if (!function_exists('tpl_form_field_calendar')) {
...
// 多文件上传
if (!function_exists('tpl_form_field_multi_audio')) {
