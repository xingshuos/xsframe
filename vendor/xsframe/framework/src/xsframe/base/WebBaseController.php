...
abstract class WebBaseController extends BaseController
{
    ...
    {
        if (method_exists($this, '_web_initialize_before')) {
            $this->_web_initialize_before();
        }

        parent::_base_initialize(); // TODO: Change the autogenerated stub

        if (method_exists($this, '_home_initialize')) {
            $this->_home_initialize();
        }

        if (method_exists($this, '_web_initialize')) {
            $this->_home_initialize();
        }
    }

    // 初始化
    protected function _web_initialize_before()
    {
    }
    ...
    // 初始化
    protected function _web_initialize()
    {
    }
