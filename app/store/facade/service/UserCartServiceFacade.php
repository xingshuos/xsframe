...
use app\store\service\UserCartService;
use think\Facade;
 ...
 * @method static addCart($userId, int $goodsId, int $optionid, int $total)
 */
class UserCartServiceFacade extends Facade
{
    protected static function getFacadeClass()
    {
        return UserCartService::class;
    }
}