...
use app\store\service\ChaptersItemService;
use think\Facade;
 ...
 * @method static getItemsAll($goodsId, int $type = 1)
 */
class ChaptersItemServiceFacade extends Facade
{
    protected static function getFacadeClass()
    {
        return ChaptersItemService::class;
    }
}