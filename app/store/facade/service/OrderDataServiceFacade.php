...
use app\store\service\OrderDataService;
use think\Facade;
 ...
 * @method static create($userId, int $id, int $type, int $total, int $addressId, int $isCart)
 * @method static getDataInfo($userId, $orderId)
 */
class OrderDataServiceFacade extends Facade
{
    protected static function getFacadeClass()
    {
        return OrderDataService::class;
    }
}