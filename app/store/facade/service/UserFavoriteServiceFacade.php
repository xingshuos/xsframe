...
use app\store\service\UserFavoriteService;
use think\Facade;
 ...
 * @method static addFavorite($userId, int $goodsId)
 */
class UserFavoriteServiceFacade extends Facade
{
    protected static function getFacadeClass()
    {
        return UserFavoriteService::class;
    }
}