...
use app\store\service\GoodsHistoryService;
use think\Facade;
 ...
 * @method static updateHistory($userId, int $id)
 */
class GoodsHistoryServiceFacade extends Facade
{
    protected static function getFacadeClass()
    {
        return GoodsHistoryService::class;
    }
}